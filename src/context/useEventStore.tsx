...
// import { CalendarEvent, DBCalendarEvent } from "../db/schema";

// interface EventStoreContextType {
//     events: CalendarEvent[];
//     isLoading: boolean;
//     error: Error | null;
//     refreshEvents: () => Promise<DBCalendarEvent[]>;
//     addEvents: (event: DBCalendarEvent | DBCalendarEvent[]) => Promise<boolean>;
//     updateEvent: (event: DBCalendarEvent) => Promise<boolean>;
//     deleteEvent: (id: string) => Promise<boolean>;
//     getEvent: (id: string) => DBCalendarEvent | undefined;
// }
...
//         async (event: DBCalendarEvent | DBCalendarEvent[]) => {
//             setError(null);
//             try {
